  ...
  return (
    <>
      <div className='flex min-h-screen bg-white relative'>
        {/* Sidebar */}
        <div className='w-2/6 bg-[#f2f2f2] min-h-screen'></div>
        {/* Main Content */}
        <div className='flex justify-end items-center w-5/6 pr-12'>
          <div className='bg-[#ffe16e] rounded-2xl shadow-lg p-6 w-96 h-[48rem] flex flex-col justify-center'>
        ...
        {/* Login2 Component */}
        <div className="absolute bottom-[5rem] left-[20rem]">
          <Login2 />
        </div>
      </div>
    </>
