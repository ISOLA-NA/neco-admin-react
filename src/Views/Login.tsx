  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // حالت OTP
        ...
        // در مثال شما فقط کد ارسال می‌شود و هنوز لاگین واقعی با OTP را پیاده‌سازی نکرده‌اید.
        // می‌توانید اینجا صرفاً کد ارسال را تست کنید یا فرمی دیگر برای وارد کردن کد OTP بسازید.
        const seqKey = generateSeqKey();
          ...
          {!isOtp ? (
            ...
            <>
              {/* در حالت OTP فقط شماره تلفن را می‌گیریم؛
                  مابقی (مثل دریافت کد و تایید) بسته به نیاز شماست. */}
              <DynamicInput
                name="PhoneNumber"
                type="number"
                value={phoneNumber}
