                ...
                >
                  ...
                  <td className="p-2 text-center whitespace-nowrap">
                    <button
                      ...
                      className="px-2 py-1 rounded bg-blue-500 text-white hover:bg-blue-600 text-[0.8rem] mx-1"
                    >
                      <FaEdit />
                    </button>
                    <button
                      ...
                      className="px-2 py-1 rounded bg-red-500 text-white hover:bg-red-600 text-[0.8rem] mx-1"
                    >
                      <FaTrash />
                    </button>
                  </td>
