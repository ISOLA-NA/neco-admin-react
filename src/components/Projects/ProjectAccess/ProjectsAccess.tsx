  ...
  ({ selectedProject }, ref) => {
    ...
    return (
      <div className="flex flex-col h-full w-full bg-gray-50 rounded-md">
        ...
        {/* wrapper with horizontal scrolling */}
        <div className="overflow-x-auto flex-1">
          <div className="flex flex-nowrap gap-2 p-2">
            {/* Left panel: min-width forces scroll earlier */}
            <div className="flex-shrink-0 min-w-[600px] h-[95vh] bg-white rounded-md border border-gray-200 shadow-sm flex flex-col">
              <LeftProjectAccess
