    ...
    <div className="p-2 bg-gray-50 flex items-center justify-center ">
      <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0">
          ...
          <button
            type="button"
            className="flex items-center bg-gradient-to-r from-green-500 to-blue-600 text-white px-5 py-2 rounded-lg shadow-md hover:from-green-600 hover:to-blue-700 transition duration-300"
          ...
          <div className="flex flex-col space-y-2">
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                className="w-5 h-5 text-green-600 border-gray-300 focus:ring-green-500"
              />
              <span className="text-gray-700">New Excel Panel</span>
            </label>
          </div>
        </div>
            ...
            <div className="flex flex-col space-y-6 bg-gray-100 p-6 rounded-lg shadow-inner">
              ...
              <div className="flex items-center space-x-4">
                ...
                <DynamicInput
                  ...
                  className="flex-grow bg-white border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-300"
                />
