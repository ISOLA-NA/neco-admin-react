      ...
      <div className="w-full">
        <div className="border border-gray-300 rounded-lg w-full">
          ...
          <div className="relative">
            <div className="flex space-x-2 overflow-x-auto scrollbar-hide px-8 py-2 bg-white border-b border-gray-300">
          ...
          <div className="relative mt-2">
            <div className="flex items-start space-x-4 overflow-x-auto scrollbar-hide px-8 py-2 bg-white border-b border-gray-300">
        ...
        {/* Component Content */}
        <div className="p-4 bg-white mt-4 border border-gray-300 rounded-lg flex-grow overflow-auto">
